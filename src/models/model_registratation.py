...
# create logger
logger = logging.getLogger("model_registratation")
...
dagshub.init(repo_owner='mltweakster', 
             repo_name='Delivery-Time-Prediction', 
             mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/mltweakster/Delivery-Time-Prediction.mlflow")
